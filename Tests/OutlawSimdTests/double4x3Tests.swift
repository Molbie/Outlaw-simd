...
class double4x3Tests: XCTestCase {
    private typealias keys = simd_double4x3.keys
    private typealias subkeys = SIMD3<Double>.keys
    private typealias indexes = simd_double4x3.indexes
    private typealias subindexes = SIMD3<Double>.indexes
