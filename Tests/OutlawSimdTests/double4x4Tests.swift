...
class double4x4Tests: XCTestCase {
    private typealias keys = simd_double4x4.keys
    private typealias subkeys = SIMD4<Double>.keys
    private typealias indexes = simd_double4x4.indexes
    private typealias subindexes = SIMD4<Double>.indexes
    ...
    func testExtractableValue() {
        ...
        let value: double4x4 = try! data.value(for: "value")
    ...
    func testInvalidValue() {
        ...
        do {
            let _: double4x4 = try data.value(for: 0)
        }
        catch {
