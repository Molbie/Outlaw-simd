...
class double3x2Tests: XCTestCase {
    private typealias keys = simd_double3x2.keys
    private typealias subkeys = SIMD2<Double>.keys
    private typealias indexes = simd_double3x2.indexes
    private typealias subindexes = SIMD2<Double>.indexes
