...
extension simd_double3x2: Value {
    public static func value(from object: Any) throws -> simd_double3x2 {
        if let data = object as? Extractable {
            ...
            return simd_double3x2(columns: (col0, col1, col2))
        }
...
extension simd_double3x2: Serializable {
...
extension simd_double3x2: IndexSerializable {
