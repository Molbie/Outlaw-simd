...
extension simd_double4x3: Value {
    public static func value(from object: Any) throws -> simd_double4x3 {
        if let data = object as? Extractable {
            ...
            let col3: simd_double3 = try data.value(for: keys.column3)
            
            return simd_double4x3(columns: (col0, col1, col2, col3))
        }
            ...
            let col3: simd_double3 = try data.value(for: indexes.column3)
...
extension simd_double4x3: Serializable {
...
extension simd_double4x3: IndexSerializable {
