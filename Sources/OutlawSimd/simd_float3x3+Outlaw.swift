...
extension simd_float3x3: Value {
    public static func value(from object: Any) throws -> simd_float3x3 {
...
extension simd_float3x3: Serializable {
...
extension simd_float3x3: IndexSerializable {
