...
extension simd_float3x4: Value {
    public static func value(from object: Any) throws -> simd_float3x4 {
        if let data = object as? Extractable {
            ...
            return simd_float3x4(columns: (col0, col1, col2))
        }
...
extension simd_float3x4: Serializable {
...
extension simd_float3x4: IndexSerializable {
