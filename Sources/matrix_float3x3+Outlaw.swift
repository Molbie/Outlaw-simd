...
public extension matrix_float3x3 {
    ...
    fileprivate typealias keys = matrix_float3x3.ExtractableKeys
    fileprivate typealias indexes = matrix_float3x3.ExtractableIndexes
}

extension matrix_float3x3: Value {
    public static func value(from object: Any) throws -> matrix_float3x3 {
...
extension matrix_float3x3: Serializable {
...
extension matrix_float3x3: IndexSerializable {
