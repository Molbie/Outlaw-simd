...
public extension matrix_double3x4 {
    ...
    fileprivate typealias keys = matrix_double3x4.ExtractableKeys
    fileprivate typealias indexes = matrix_double3x4.ExtractableIndexes
}

extension matrix_double3x4: Value {
    public static func value(from object: Any) throws -> matrix_double3x4 {
...
extension matrix_double3x4: Serializable {
...
extension matrix_double3x4: IndexSerializable {
