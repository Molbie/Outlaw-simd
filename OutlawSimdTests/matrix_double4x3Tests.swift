...
class matrix_double4x3Tests: XCTestCase {
    ...
    func testExtractableValue() {
        ...
        let value: matrix_double4x3 = try! data.value(for: "value")
    ...
    func testIndexExtractableValue() {
        ...
        let value: matrix_double4x3 = try! data.value(for: 0)
    ...
    func testInvalidValue() {
        ...
        do {
            let _: matrix_double4x3 = try data.value(for: 0)
        }
        catch {
