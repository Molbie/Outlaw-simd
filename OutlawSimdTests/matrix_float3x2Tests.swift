...
class matrix_float3x2Tests: XCTestCase {
    ...
    func testExtractableValue() {
        ...
        let value: matrix_float3x2 = try! data.value(for: "value")
    ...
    func testIndexExtractableValue() {
        ...
        let value: matrix_float3x2 = try! data.value(for: 0)
    ...
    func testInvalidValue() {
        ...
        do {
            let _: matrix_float3x2 = try data.value(for: 0)
        }
        catch {
    ...
    func testSerializable() {
        let value = matrix_float3x2(columns: (vector_float2(0, 10),
                                              vector_float2(1, 11),
                                              vector_float2(2, 12)))
